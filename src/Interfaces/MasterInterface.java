...
public interface MasterInterface extends Remote {
	...
	public boolean createFile(String path, String fileName, int numReplicas, int clientID) throws RemoteException;
	public void deleteFileMaster(String chunkhandle, int clientID) throws RemoteException;
	public boolean createDirectory(String path, int clientID) throws RemoteException;
